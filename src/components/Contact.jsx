...
const Contact = () => {
  ...
  return (
    <div className="xl:mt-12 flex flex-col-reverse lg:flex-row gap-5 overflow-hidden">
      <motion.div
      ...
      <motion.div
        ...
        className="flex-1 flex h-[300px] md:h-[400px] lg:h-auto"
      >
        <EarthCanvas />
      </motion.div>
    </div>
